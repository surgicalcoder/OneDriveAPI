...
public class OneDriveConsumerApi : OneDriveApi
{
    ...
    /// </summary>
    /// <param name="scopes">
    /// String with one or more scopes separated with a space to which you want to request access. See
    /// https://msdn.microsoft.com/en-us/library/office/dn631845.aspx for the scopes that you can use.
    /// </param>
    ...
    /// <summary>
    /// Returns the Uri that needs to be called to authenticate to the OneDrive API using the default scope of "wl.signin
