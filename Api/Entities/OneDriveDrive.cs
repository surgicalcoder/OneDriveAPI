...
/// <summary>
/// The Drive resource represents a drive in OneDrive. It provides information about the owner of the drive, total and
/// available storage space, and exposes a collection of all the Items contained within the drive.
/// </summary>
