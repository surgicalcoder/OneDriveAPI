...
public class OneDriveIdentity : OneDriveItemBase
{
    ...
    /// changes their display name, OneDrive may show the new value in a future response, but the items associated with the
    /// user won't show up as having changed in view.changes
    /// </summary>
