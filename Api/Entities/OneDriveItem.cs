...
/// are Item resources. If an item is a Folder or File facet, the Item resource will contain a value for either the
/// folder or file property, respectively.
/// </summary>
public class OneDriveItem : OneDriveItemBase
{
    ...
    /// <summary>
    /// The conflict resolution behavior for actions that create a new item. An item will never be returned with this
    /// annotation. Write-only.
    /// </summary>
    ...
    /// <summary>
    /// When issuing a PUT request, this instance annotation can be used to instruct the service to download the contents
    /// of the URL, and store it as the file. Write-only.
    /// </summary>
