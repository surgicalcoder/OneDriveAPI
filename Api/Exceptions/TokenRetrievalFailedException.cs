...
public class TokenRetrievalFailedException : Exception
{
    ...
    public TokenRetrievalFailedException(string message = null, OneDriveError errorDetails = null, Exception innerException = null) : base("Failed to retrieve OneDrive access token." + (string.IsNullOrEmpty(message) ? string.Empty : " Additional information: " + message), innerException) { }
}